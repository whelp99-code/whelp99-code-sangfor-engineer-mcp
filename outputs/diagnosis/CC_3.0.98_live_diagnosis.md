...
- 요약: 잘못됨 0 · 추가 필요 1 · 환경 의존 0 · 판정 불가 3 · 정상 2
- 종합 판정(ok): **조치 필요**
...
- **알림 채널(Email/SMS/Syslog) 구성** (기대: true, 실제: false) 
  - 근거: Cyber Command 3.0 User Manual — Alerts / Notification
  - 출처: support.sangfor.com CC 3.0 User Manual 
  - 관측(수집기 주장, 미검증): POST /apps/secvisual/alarm/alarm_policy/on_list @ 2026-07-03T13:05:28.649Z [live-xhr]
...
- **알람 노이즈 튜닝 구성됨(환경 의존)** (기대: undefined, 실제: true) 
...
- **정기 리포트 스케줄 구성됨** (기대: undefined, 실제: true) 
  ...
  - 관측(수집기 주장, 미검증): POST /apps/secvisual/home/home/get_report_tag @ 2026-07-03T13:05:28.649Z [live-xhr]

## 커버리지 (감사 범위)

- 스펙 항목 6개 중 관측값 미확인 3개 (ntp_synced, event_sources_active, syslog_forwarding_present)
...
> 수집: 10.80.1.107 라이브 콘솔 XHR 37개 엔드포인트 (read-only)

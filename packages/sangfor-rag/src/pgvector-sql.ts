...
export const EXACT_SEARCH_SQL = `
SELECT c."id",c."text",c."title",c."sourceRef",(e."embedding" <=> $8::vector) AS "distance"
FROM "BlroRagEmbedding" e
JOIN "BlroRagAuthoritativeChunk" c
  ON c."tenantId"=e."tenantId" AND c."projectId"=e."projectId" AND c."id"=e."chunkId"

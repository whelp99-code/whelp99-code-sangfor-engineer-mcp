...
const approvalSchema = z.union([
  z.object({ ...approvalFields, authorityEpoch: z.literal(0) }).strict(),
  z.object(approvalFields).strict().transform((approval) => ({ ...approval, authorityEpoch: 0 })),
]);

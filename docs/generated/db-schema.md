...
| `BlroRagEmbeddingCohort` | composite scope/id, index epoch, backend/model/dimensions, embeddingSpace/digest, active | Database-enforced single active cohort per tenant/project scope. Legacy unverified spaces are deactivated; new vectors require the complete pinned space. |

...
| `@sangfor/rag` | L1 | ingest→chunk→embed plus project-scoped PostgreSQL/pgvector authority and semantic search/rerank; legacy JSON is derived-only |

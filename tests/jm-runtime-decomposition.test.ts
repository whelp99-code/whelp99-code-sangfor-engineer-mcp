...
const FAMILY_PREFIX = 'jm-browser-agent-runtime';
const MAX_PURE_LINES = 250;
const MIN_FAMILY_MODULES = 2;
// Case count of the pre-split jm-browser-agent-runtime monolith — parity lock.
const EXPECTED_FAMILY_CASE_COUNT = 36;
...
describe('jm-browser-agent-runtime test decomposition', () => {
  it('Given every jm-browser-agent-runtime test module, When measured, Then each stays within the reviewable pure-line limit', () => {
  ...
  it('Given the JM runtime suite, When its modules are enumerated, Then the family spans sibling modules instead of a single monolith', () => {
